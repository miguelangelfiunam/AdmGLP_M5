...
//	private Set<UsuarioRol> usuariosRoles;
	...
	public ContraDTO getContraDTO() {
		return contraDTO;
	}

	public void setContraDTO(ContraDTO contraDTO) {
	...
	public String toString() {
		return "UsuarioDTO [idUsuario=" + idUsuario + ", idContra=" + idContra + ", apodo=" + apodo + ", correo1="
				+ correo1 + ", correo2=" + correo2 + ", nombre=" + nombre + ", apellido1=" + apellido1 + ", apellido2="
				+ apellido2 + ", edad=" + edad + ", fechaNacimiento=" + fechaNacimiento + ", telefono1=" + telefono1
				+ ", telefono2=" + telefono2 + ", fecRegistro=" + fecRegistro + ", fecActualizacion=" + fecActualizacion
				+ ", estatus=" + estatus + "]";
	}
