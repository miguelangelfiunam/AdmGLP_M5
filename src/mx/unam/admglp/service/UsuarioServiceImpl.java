...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public Usuario insertarUsuario(Usuario usuario) {
		...
		UsuarioDTO usuarioDTO = new UsuarioDTO(idContra, usuario.getApodo(), usuario.getCorreo1(),
				usuario.getCorreo2(), usuario.getNombre(), usuario.getApellido1(), usuario.getApellido2(),
				usuario.getEdad(), usuario.getFechaNacimiento(), usuario.getTelefono1(), usuario.getTelefono2(),
				usuario.getFecRegistro(), usuario.getFecActualizacion(), usuario.getEstatus());
